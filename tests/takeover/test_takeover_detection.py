...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("", "Oracle - Investor Relations - SEC Filings", {"img[id*=captcha]": True}, ("captcha", "Image captcha detected")),
        ("", "Some page", {"recaptcha": False}, None),
        ("", "Some page", {"recaptcha": True}, ("captcha", "reCAPTCHA detected")),
        ("", "Some page", {"hcaptcha": True}, ("captcha", "hCaptcha detected")),
        ("", "Some page", {"challenges.cloudflare.com": False}, None),
        ("", "Some page", {"challenges.cloudflare.com": True}, ("captcha", "Cloudflare Turnstile detected")),
        ("", "Sign in to My Account", {"input[type=password]": True}, ("login", "Login page detected")),
        ("", "Sign in to My Account", {"input[type=password]": False}, None),
        ("https://accounts.google.com/signin/oauth", "Some page", {}, ("oauth", "Google OAuth authorization page detected")),
        ("https://login.microsoftonline.com/xyz", "Some page", {}, ("oauth", "Microsoft OAuth authorization page detected")),
        ("", "Checking your browser before accessing", {}, ("antibot", "Anti-bot page detected")),
        ("", "Cloudflare attention required", {}, ("antibot", "Cloudflare protection detected")),
        # 中国互联网场景：中文登录页（login 关键词扩展）
        ("", "国家税务总局广东省税务局-登录", {"input[type=password]": True}, ("login", "Login page detected")),
        # 中国互联网场景：扫码登录（qrcode）
        ("", "国家税务总局广东省税务局-登录", {"input[type=password]": False, "img[src*=qrcode]": True}, ("qrcode", "QR code login page detected")),
        ("", "登录", {"input[type=password]": False, "canvas": True}, ("qrcode", "QR code login page detected")),
        ("", "登录", {"input[type=password]": False, "img[src*=qrcode]": False}, None),
        # 中国互联网场景：国产图形验证码
        ("", "Some page", {".geetest_panel": True}, ("captcha", "Image captcha detected")),
        ("", "Some page", {"[class*=yidun]": True}, ("captcha", "Image captcha detected")),
        ("", "Some page", {"iframe[id*=tcaptcha]": True}, ("captcha", "Image captcha detected")),
        ("", "Some page", {"[class*=aliyunCaptcha]": True}, ("captcha", "Image captcha detected")),
        ("", "Some page", {"img[class*=yzm]": True}, ("captcha", "Image captcha detected")),
        ("", "安全验证", {}, ("captcha", "Image captcha detected")),
        ("", "人机验证", {}, ("captcha", "Image captcha detected")),
