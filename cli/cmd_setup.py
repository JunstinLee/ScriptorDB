...
from config.settings import load_for_workspace, set_default_model, settings
from config.workspace import WorkspaceNotFoundError, WorkspaceSettings
...
def setup(
    ...
    model_choice = typer.prompt(
        "\nChoose default model (or press Enter to skip)", type=int, default=0, show_default=False
    )
